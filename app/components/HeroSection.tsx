        ...
        <div className="items-center relative z-20 md:pt-[218px] pt-[100px]">
          ...
          <div className="text-white items-center">
            ...
            <div className="flex items-center gap-3">
              <button className="bg-[#FFDA18] text-[#355332] md:px-[55px] px-[20px] md:py-[24px] py-[18px] md:w-auto w-full rounded-full md:text-[17px] text-[12px] leading-[120%] tracking-[-2%] font-semibold transition-colors cursor-pointer">
                LEARN MORE
              </button>
            </div>
          </div>
