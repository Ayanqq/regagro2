                ...
                <div className="relative flex items-center px-7.5 pt-[60px] gap-[174px] z-20">
                    ...
                    <div className="mt-[110px] flex flex-col gap-12 relative">
                        ...
                        <div className="flex flex-col items-start">
                            ...
                            <h3 className="text-[20px] font-semibold text-[#355332] mb-1 mt-2.5 leading-[120%] tracking-[-2%]">Wide
                                range of products</h3>
                            <p className="text-[12px] text-gray-600 leading-[120%] tracking-[-2%]">Our catalog features
                        ...
                        <div className="flex flex-col items-start leading-[120%]">
                            ...
                            <h3 className="text-[20px] font-semibold text-[#355332] mb-1 mt-2.5 leading-[120%] tracking-[-2%]">Fast
                                delivery</h3>
                            <p className="text-[12px] text-gray-600 leading-[120%] tracking-[-2%]">We understand that
