                ...
                <div className="z-20 relative pt-[60px]">
                    ...
                    <div className={'flex gap-[115px] mt-[25px]'}>
                        <form className={'w-[615px] flex flex-col gap-[30px]'}>
                            <div className={'flex flex-col gap-[15px]'}>
                                <div className={'flex gap-[15px]'}>
                                    <input type={'text'} placeholder={'Your name*'}
                                           className="max-w-[300px] w-full py-[24px] px-[30px] border-[#4F584E80]/50 border-[0.5px] rounded-full text-[17px] text-[#4F584E] font-normal h-[68px]"/>
                                    <input type={'tel'} placeholder={'Phone number*'}
                                           className={'max-w-[300px] w-full py-[24px] px-[30px] border-[#4F584E80]/50 border-[0.5px] rounded-full text-[17px] text-[#4F584E] font-normal h-[68px]'}/>
                                </div>
                                <textarea placeholder={'Comment / Question'}
                                          className={'h-[150px] p-[30px] border-[#4F584E80]/50 border-[0.5px] w-full resize-none rounded-[24px] text-[#4F584E]'}></textarea>
                            ...
                            <button type={'submit'}
                                    className={'bg-[linear-gradient(90deg,#FFDA18_0%,#FFE55E_100%)] w-full py-[24px] font-semibold rounded-full cursor-pointer text-[#355332]'}>SUBMIT
                                A REQUEST
                            </button>
                        </form>
                        ...
                        <div className={'flex gap-[190px]'}>
                            <nav className={'flex flex-col gap-[15px]'}>
                                ...
                                <ul className={'flex flex-col gap-[10px] text-[17px] text-[#4F584E] '}>
                                    <li>About us</li>
                                    <li>Catalog</li>
                                    <li>IT Solutions</li>
                                    <li>Contacts</li>
                            ...
                            <nav className={'flex flex-col gap-[15px]'}>
                                ...
                                <ul className={'flex flex-col gap-[15px] text-[17px] text-[#4F584E]'}>
                                    <li>Address</li>
                                    <li>Phone</li>
                                    <li>Email</li>
                                    <li>Social Media</li>
