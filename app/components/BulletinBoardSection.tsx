        ...
        <section id="bulletin-board" className="relative pt-[60px] md:pt-[125px]">
            <Container className="relative">
                ...
                <div className="z-20 relative md:pt-[60px] pt-[30px]">
                    ...
                    <div>
                        <div className={'max-w-[650px] flex flex-col md:gap-[20px] gap-[15px]'}>
                            <p className={'md:text-[17px] text-[14px] font-normal text-[#4F584E] leading-[120%] mt-[15px] md:max-w-[609px] max-w-[345px]'}>Verify animals’ breed and
                                registration
                    ...
                    <div className={'md:hidden block mt-[15px]'}>
                        <div className={'flex flex-col gap-[7px]'}>
                            <div className={'flex flex-row gap-[8px]'}>
                                <Image alt={'bulletinboard'} src="/images/bulletinboard/bullet-1.png" width={28} height={28} className="size-[28px]"/>
                            ...
                            <div className={'flex flex-row gap-[8px]'}>
                                <Image alt={'bulletinboard'} src="/images/bulletinboard/bullet-2.png" width={28} height={28} className="size-[28px]"/>
                                <p className={'text-[#4F584E] text-[14px] font-normal leading-[120%]'}>
                                02. Integration with a mobile app for animal detection</p>
                            </div>
                            <div className={'flex flex-row gap-[8px]'}>
                                <Image alt={'bulletinboard'} src="/images/bulletinboard/bullet-3.png" width={28} height={28} className="size-[28px]"/>
                                <p className={'text-[#4F584E] text-[14px] font-normal leading-[120%]'}>
                    ...
                    <button
                            className="md:hidden block md:text-[17px] text-[14px] md:mt-[30px] mt-[20px] bg-[linear-gradient(90deg,#FFDA18_0%,#FFE55E_100%)] md:px-[60px] md:py-[24px] py-[18px] md:w-auto w-full max-w-[420px] rounded-full font-semibold text-[#355332] cursor-pointer leading-[120%] tracking-[-2%]">
                            OPEN THE BULLETIN BOARD
                        </button>
