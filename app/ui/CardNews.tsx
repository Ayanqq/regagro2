...
export const CardNews = () => {
    return (
        <div className={'flex flex-col mb-[5px] mr-[10px] gap-[15px] bg-[#FAFAFA] md:bg-transparent max-w-[330px] md:max-w-[385px] px-[20px] pb-[40px] pt-[20px] rounded-[18px] relative md:static'}>
