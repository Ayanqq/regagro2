...
export const Headtitle = ({minTitle, title}: HeadtitleType) => {
    return (
        <div className={'flex flex-col gap-[5px] md:gap-[10px] z-2'}>
            <div
            ...
            <h2 className={'text-[24px] md:text-[42px] font-bold text-[#355332] max-w-[790px] font-jakarta leading-[105%] md:leading-[44px] tracking-[-2%]'}>{title}</h2>
        </div>
    );
};
